...
![Figure 1. System diagram depicting (a) training procedure and (b) inference procedure.](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled.png)
...
- **VITS**는 **conditional VAE**로 표현 가능함
    ...
    ![The variational lower bound, also called the evidence lower bound (ELBO), of the intractable marginal log-likelihood of data](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%201.png)
...
- **Reconstruction loss**
    ...
    ![The L1 loss between the predicted and target mel-spectrogram used as the reconstruction loss](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%202.png)
...
- **KL-divergence loss**
    ...
    ![The KL divergence loss](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%203.png)
    ...
    ![Applying a normalizing flow on top of the factorized normal prior distribution](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%204.png)
...
- **Glow-TTS**에서 사용했던 **Monotonic Alignment Search (MAS)를 활용함**
    ...
    ![An alignment that maximizes the likelihood of data parameterized by a normalizing flow $f$](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%205.png)
...
- **Glow-TTS**와 다르게, **정확한 log-likelihood가 아닌 objective인 ELBO를 최대화**해야하기 때문에, **ELBO를 최대화하는 alignment를 찾는 것**으로 MAS 알고리즘을 재정의해야함
    ...
    ![Redefining MAS to find an alignment that maximizes the ELBO](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%206.png)
...
- **Duration prediction from text**
    ...
    - **Stochastic duration predictor**는 flow기반의 생성 모델이고 maximum likelihood estimation을 통해 학습함
        ...
        ![The resulting objective: a variational lower bound of the log-likelihood of the phoneme duration](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%207.png)
...
![The least-squares loss function for adversarial training, and the additional feature-matching loss for training the generator](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%208.png)
...
![Final loss](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%209.png)
...
![Figure 5. Block diagram depicting (a) training procedure and (b) inference procedure of the stochastic duration predictor. The main building block of the stochastic duration predictor is (c) the dilated and depth-wise separable convolutional residual block.](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2010.png)
...
- Dilated and depth-separable convolution layer (**DDSConv**)로 이루어진 residual block을 사용해서 large receptive field size를 유지하면서 parameter efficiency를 향상시킴
    ...
    ![Figure 6. The architecture of (a) condition encoder and (b) coupling layer used in the stochastic duration predictor.](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2011.png)
...
![Table 1](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2012.png)
...
![Table 2](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2013.png)
...
![Table 3](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2014.png)
...
![Figure 2.(a) Sample duration on LJ Speech dataset ](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2015.png)
...
![Figure 2.(b) Sample duration on VCTK datset](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2016.png)
...
![Figure 3. Pitch tracks for the utterance “How much variation is there?”.](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2017.png)
...
![Table 4](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2018.png)
...
- Glow-TTS와 다른 점은, VITS는 mel-spectrogram이 아닌 raw waveform을 제공함
    ...
    ![Figure 7. Pitch tracks of a ground truth sample and the corresponding voice conversion samples with different speaker identities.](assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2019.png)
