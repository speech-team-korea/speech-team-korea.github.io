...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled.png)
...
- **VITS**는 **conditional VAE**로 표현 가능함
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%201.png)
...
- **Reconstruction loss**
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%202.png)
...
- **KL-divergence loss**
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%203.png)
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%204.png)
...
- **Glow-TTS**에서 사용했던 **Monotonic Alignment Search (MAS)를 활용함**
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%205.png)
...
- **Glow-TTS**와 다르게, **정확한 log-likelihood가 아닌 objective인 ELBO를 최대화**해야하기 때문에, **ELBO를 최대화하는 alignment를 찾는 것**으로 MAS 알고리즘을 재정의해야함
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%206.png)
...
- **Duration prediction from text**
    ...
    - **Stochastic duration predictor**는 flow기반의 생성 모델이고 maximum likelihood estimation을 통해 학습함
        ...
        ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%207.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%208.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2010.png)
...
- Dilated and depth-separable convolution layer (**DDSConv**)로 이루어진 residual block을 사용해서 large receptive field size를 유지하면서 parameter efficiency를 향상시킴
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2011.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2012.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2013.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2014.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2015.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2016.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2017.png)
...
![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2018.png)
...
- Glow-TTS와 다른 점은, VITS는 mel-spectrogram이 아닌 raw waveform을 제공함
    ...
    ![](/assets/img/2023-12-07-write-VITS/2023-12-07-write-VITS/Untitled%2019.png)
